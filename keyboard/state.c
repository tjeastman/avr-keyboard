...
struct key_map keys[] = {
  ...
  {{0x69, 1, 0}, {0x4D, "[END]", NULL}},
  {{0x6B, 1, 0}, {0x50, "[LEFT]", NULL}},
  {{0x6C, 1, 0}, {0x4A, "[HOME]", NULL}},
  {{0x70, 1, 0}, {0x49, "[INS]", NULL}},
  {{0x71, 1, 0}, {0x4C, "[DEL]", NULL}},
  {{0x72, 1, 0}, {0x51, "[DOWN]", NULL}},
  {{0x74, 1, 0}, {0x4F, "[RIGHT]", NULL}},
  {{0x75, 1, 0}, {0x52, "[UP]", NULL}},
  {{0x76, 0, 0}, {0x29, "[ESC]", NULL}},
  {{0x77, 0, 0}, {0x53, "[NUM]", NULL}},
  {{0x78, 0, 0}, {0x44, "[F11]", NULL}},
  {{0x7A, 1, 0}, {0x4E, "[PGDOWN]", NULL}},
  {{0x7D, 1, 0}, {0x4B, "[PGUP]", NULL}},
